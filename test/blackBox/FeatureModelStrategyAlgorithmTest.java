...
public class FeatureModelStrategyAlgorithmTest {
	...
	//Multiple Features, All optional (4), Non selected
		...
		//Multiple Features/Features, Mandatory(3), Optional(3) All Selected
		@Test
		public void test83() {
			String testFile = "TestCase81-83.jucm";
			try {
		...
		//Multiple Features/Features, All Optional. All Selected
		@Test
		public void test86() {
			String testFile = "TestCase84-86.jucm";
			try {
		...
		//Multiple Features/Features, Optional(3), And(1). All Selected
		@Test
		public void test89() {
			String testFile = "TestCase87-89.jucm";
			try {
		...
		//Multiple Features/Links, >1 Optional , >1 And. 1 Selected
		@Test
		public void test91() {
			String testFile = "TestCase87-89.jucm";
			try {
			...
			while (it.hasNext()) {
				IntentionalElement element = (IntentionalElement) it.next();
				if (element.getName().compareTo("A02") == 0) {
					eval.put(element, selected);
				} else {
					eval.put(element, notSelected);
				}
		...
		//Multiple Features/Features, >1 Optional,  >1 And. All Selected
		@Test
		public void test92() {
			String testFile = "TestCase90-92.jucm";
			try {
